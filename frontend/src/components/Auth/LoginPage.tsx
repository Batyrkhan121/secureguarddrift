...
export default function LoginPage() {
  ...
  return (
    <div className="fixed inset-0 bg-[#1a1a2e] flex items-center justify-center">
      <form onSubmit={handleSubmit} className="bg-[#16213e] border border-[#0f3460] rounded-xl p-8 w-[340px]">
        ...
        <input
          ...
          className="w-full p-2.5 mb-2.5 bg-[#0f3460] text-gray-200 border border-[#0f3460] rounded text-sm"
        />
        {error && <div className="text-critical text-sm text-center mb-2">{error}</div>}
        <button
          type="submit"
          disabled={loading}
